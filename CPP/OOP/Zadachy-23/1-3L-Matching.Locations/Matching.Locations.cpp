...
After all locations are entered, a single line containing the '.' (dot) the character will be entered.
...
After all queries are entered, a single line containing the '.' (dot) the character will be entered.
